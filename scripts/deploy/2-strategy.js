...
async function main() {
  ...
  const scSPELL = '0xb19b33fff3a9b21f120b6ac585b8ce21635beb96';

  // const options = { gasPrice: 2000000000000, gasLimit: 9000000 };

  const strategy = await hre.upgrades.deployProxy(
    Strategy,
    [vaultAddress, [treasuryAddress, paymentSplitterAddress], [strategist1, strategist2, strategist3], scSPELL],
    { kind: 'uups' },
  );
