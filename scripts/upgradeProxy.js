const wbtcProxy = '0x49D77552b4710bBf2F8176835e08BE885744734c';
const options = { gasPrice: 700000000000 };
...
const getStrategy = async () => {
  ...
  const strategy = Strategy.attach(wbtcProxy);
  return strategy;
};

const upgradeProxy = async () => {
  const stratFactory = await ethers.getContractFactory('ReaperAutoCompoundScreamLeverage');
  await hre.upgrades.upgradeProxy(wbtcProxy, stratFactory, { ...options, timeout: 0 });
